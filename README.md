...
| Map          | Description                                                                                                                                                                                                                                                                                                                                                                                |
|--------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `<leader>ve` | **V**im **E**dit. Open `init.lua`. When executed from a project, open in a new tab. If executed from the vim configuration, open in current window <br />When opening a tab, the current working dir is set for the tab to allow navigation and git commands to operate on the vim configuration, while the original file remains in the scope of the original working dir for the project |
| `<leader>vs` | **V**im **S**ource. Run `:source $MYVIMRC`, rerunning the configuration. Remember to save before running                                                                                                                                                                                                                                                                                   |
| `<leader>vx` | **V**im e**X**exute. Save and `:source %` (execute currently open file)                                                                                                                                                                                                                                                                                                                    |
